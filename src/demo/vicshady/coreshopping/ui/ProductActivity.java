...
import demo.vicshady.coreshopping.async.ProductTask;
...
public class ProductActivity extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		urlSubCatId = getIntent().getStringExtra(AppConstants.JSONTAG.CategoryTag.PARENT_CATEGORY_ID);
        ...
        ProductTask backgroundTask = new ProductTask(this,imageLoader,options, productListView, urlCatId, urlSubCatId);
